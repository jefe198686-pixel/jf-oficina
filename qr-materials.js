// JF Oficina v0.15.6 — leitor QR de materiais em OS e Orçamento
(function(){
 ...
 function currentOS(){
   // `work` é declarado com let no script principal e não vira window.work.
   // Acesso direto é o estado real da OS atualmente aberta.
   try{return (typeof work!=='undefined'&&work&&Array.isArray(work.materiais))?work:null}catch(e){return null}
 }
 function addToOS(p){
   const w=currentOS();
